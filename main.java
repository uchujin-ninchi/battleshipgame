...
class main {
    ...
    public static boolean hasMyShip(int[]pos){
        boolean check =  false;
        if(myMap.getMap(pos) == MasuData.TYPE_SHIP){
            check = true;
            break;
        }
        return check;
    ...
    public static void fleeFromhitAttacked(int[] pos){
    ...
    public static hitAttack (int pos[]) {
    ...
    public static void stateWinner() {
        if(totalHP(myShips) >totalHP(theirShips) && totalHP(theirShips) == 0){
            System.out.println("you win");
        }else if(totalHP(myShips) <totalHP(theirShips) && totalHP(myShips) == 0){
            System.out.println("teki win");
        }else{
            continue;
        }
    }
